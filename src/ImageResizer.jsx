  ...
  return (
    <div style={{
      ...
      <p style={{ color: "#94a3b8", fontSize: "0.875rem", marginBottom: "2rem" }}>
        Resize images under 1 MB — perfect for GitHub, LinkedIn, and social profiles
      </p>
      ...
      {image && (
        <div style={{ width: "100%", maxWidth: "420px" }}>
          <div style={{ marginBottom: "1rem" }}>
            ...
            <input
              type="range" min="100" max="1000" step="50" value={maxDim}
          ...
          {outputSize > 0 && (
            <div style={{
              ...
              <span style={{ color: underLimit ? "#4ade80" : "#f87171", fontWeight: 600 }}>
                Output: {formatSize(outputSize)} {underLimit ? "✓" : "✗ over 1 MB"}
              </span>
            </div>
          )}
